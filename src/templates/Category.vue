<template>
  <Layout>
    ...
    <div
      ...
      <img style="height:120px;width:120px" src="/images/Sausage and Peppers.png"/>
      ...
      <p>One of the four basic sauces.  It's a bit tricky to master, but incredibly rewarding once you get it down.</p>
      </div>
    </div>
    </div>
  </Layout>
